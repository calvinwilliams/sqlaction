...
CREATE TABLE `sqlaction_benchmark` (
  ...
  `name` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '英文县1?71¤7',
  `name_cn` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '䶿文各1?71¤7',
...
public class SqlActionBenchmarkCrud {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sqlactionBenchmark.nameCn = "卡尔政1?71¤7" ;
			...
			for( i = 0 ; i < count ; i++ ) {
				...
				sqlactionBenchmark.nameCn = "卡尔政1?71¤7"+i ;
...
public class MyBatisBenchmarkCrud {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sqlactionBenchmark.name = "Calvin" ;
			sqlactionBenchmark.name_cn = "卡尔政1?71¤7" ;
			sqlactionBenchmark.salary = new BigDecimal(0) ;
			long time = System.currentTimeMillis() ;
			sqlactionBenchmark.birthday = new java.sql.Date(time) ;
			count = 500 ;
			...
			for( i = 0 ; i < count ; i++ ) {
				sqlactionBenchmark.name = "Calvin"+i ;
				sqlactionBenchmark.name_cn = "卡尔政1?71¤7"+i ;
