...
1. Abstract fetch-last-insert-rowid or sequence syntax configuration
1. Abstract physical paging-sql syntax configuration
...
CREATE TABLE `sqlaction_benchmark` (
  ...
  `name` varchar(32) COLLATE utf8mb4_bin NOT NULL COMMENT '鑻辨枃鍘�1陇71?71陇7',
  `name_cn` varchar(128) COLLATE utf8mb4_bin NOT NULL COMMENT '涠挎枃鍚�1陇71?71陇7',
...
public class SqlActionBenchmarkCrud {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sqlactionBenchmark.nameCn = "鍗″皵鏀�1陇71?71陇7" ;
			...
			for( i = 0 ; i < count ; i++ ) {
				...
				sqlactionBenchmark.nameCn = "鍗″皵鏀�1陇71?71陇7"+i ;
...
public class MyBatisBenchmarkCrud {
	...
	public static void main(String[] args) {
		...
		try {
			...
			sqlactionBenchmark.name = "Calvin" ;
			sqlactionBenchmark.name_cn = "鍗″皵鏀�1陇71?71陇7" ;
			sqlactionBenchmark.salary = new BigDecimal(0) ;
			long time = System.currentTimeMillis() ;
			sqlactionBenchmark.birthday = new java.sql.Date(time) ;
			count = 500 ;
			...
			for( i = 0 ; i < count ; i++ ) {
				sqlactionBenchmark.name = "Calvin"+i ;
				sqlactionBenchmark.name_cn = "鍗″皵鏀�1陇71?71陇7"+i ;
